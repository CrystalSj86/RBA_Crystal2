...
if option=='Bar Chart & Dataset':
    kl_property = pd.read_csv('https://raw.githubusercontent.com/CrystalSj86/RBA_Crystal2/main/klproperty_EncodedData.csv')
    ...
    FloatData = pd.read_csv('https://raw.githubusercontent.com/CrystalSj86/RBA_Crystal2/main/klproperty_FloatData.csv')
